...
<div class="auth-side-form">
  <div class=" auth-content">
    ...
    <?php endif; ?>
    <form action="<?= base_url() ?>Auth/registerDosen" method="post">
      <div class="form-group mb-3">
        <label class="floating-label" for="kode_dosen">Kode Dosen</label>
        <input type="text" class="form-control" id="kode_dosen" name="kode_dosen" value="<?= old('kode_dosen') ?>" required>
      </div>
      <div class="form-group mb-3">
